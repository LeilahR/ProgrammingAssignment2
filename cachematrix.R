...
#Function to compute inverse of matrix x
  ...
  ##input values for following function below are the get and set functions by which we  calculated and stored the inverse in the cache
  input<-list(set = set, get = get,
